...
var (
	...
	// apiKeyID                  = "fxb2rxswvhkzs"
	// apiKeySecret              = "tkvKZ0T2RIViZlJECGKDntaC_AXQmi2W3WwWiFKrg8A"
	// assetsToTrade             = "xrp"
	// purchaseUnit              = 500.0
	// emailAddress              = "michaellormann@gmail.com"
	// profitMargin              = 3.0
	// verbose                   = true
...
func (c *Configuration) TestConfig(appDir string) error {
	flag.Parse()
	c.APIKeyID, c.APIKeySecret, c.EmailAddress = *apiKeyID, *apiKeySecret, *emailAddress
